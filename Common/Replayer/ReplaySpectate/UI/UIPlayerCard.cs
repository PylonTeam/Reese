...
internal sealed class UIPlayerCard : UIPanel
{
    ...
    public UIPlayerCard(int playerIndex, int listIndex, ReplayPlayersPanel owner, float scale = 1f)
    {
    ...
    private void AddActionButtons(ReplayPlayersPanel owner, PlayerCardAction[] actions)
    {
    ...
    private void AddActionButton(ReplayPlayersPanel owner, PlayerCardAction action, float left, float top, float size)
    {
    ...
    private sealed class PlayerCardActionButton : UIElement
    {
        ...
        public PlayerCardActionButton(int playerIndex, ReplayPlayersPanel owner, PlayerCardAction action)
        {
