...
internal sealed class WorldTab : TabPage
{
    ...
    private sealed class MiscInfo : InfoSection
    {
        ...
        {
            return "Players Online: " + SpectatorModeSystem.GetPlayersOnlineCount();
        }

        private static string GetSpectatorsOnlineText()
        {
            return "Spectators Online: " + SpectatorModeSystem.GetSpectatorCount();
        }
    ...
    private sealed class BossesDefeated : UIPanel
    {
        ...
        private bool IsMouseInsideSpectatorInfoPanel()
        {
            ...
            {
                if (element is ReplayInfoPanel panel)
