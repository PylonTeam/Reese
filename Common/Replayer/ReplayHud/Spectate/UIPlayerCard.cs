...
internal sealed class UIPlayerCard : UIPanel
{
    ...
    private void AddActionButtons(SpectateHud owner, PlayerCardAction[] actions)
    {
    ...
    private void AddActionButton(SpectateHud owner, PlayerCardAction action, float left, float top, float size)
    {
    ...
    private sealed class PlayerCardActionButton : UIElement
    {
        ...
        public PlayerCardActionButton(int playerIndex, SpectateHud owner, PlayerCardAction action)
        {
