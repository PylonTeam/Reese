...
public sealed class PlaybackHud : DraggablePanel
{
    ...
    public PlaybackHud() : base(Loc.Get("ReplayHud.Playback.Title"))
    {
        ...
        [
            ...
            CreateTransportButton(Ass.IconStop, Loc.Get("ReplayHud.Playback.StopReplay"), Playback.Stop),
    ...
    private static void SetSpeed(float value) => ModContent.GetInstance<PlaybackTimeScale>().TimeScale = value;
    ...
    {
        SetSpeed(0f);
        ModContent.GetInstance<PlaybackTimeScale>().StepOneFrame();
        RefreshVisualState();
    }
    ...
    private void RefreshVisualState()
    {
        ...
        if (sock != null)
        {
            ...
            float speed = ModContent.GetInstance<PlaybackTimeScale>().TimeScale;
