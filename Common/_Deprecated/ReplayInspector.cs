...
//{
//    public override string Command => "reeseinspect";
//    public override string Usage => "/reeseinspect [path-or-file-name]";
//    public override string Description => "Inspect a Reese replay file and log packet/tick diagnostics.";
