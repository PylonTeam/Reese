...
internal sealed class SpectatorControlsPanel : UIPanel
{
    ...
    private static void ApplyTopOrBottomPosition(UIElement element, float scale)
    {
        ...
        if (clientConfig.spectateUIPosition == ClientConfig.SpectateUIPosition.Top)
        {
            element.VAlign = 0f;
    ...
    private static float GetScale()
    {
        ...
        {
            ClientConfig.SpectateUISize.Small => 0.6f,
            ClientConfig.SpectateUISize.Medium => 0.8f,
            ClientConfig.SpectateUISize.Big => 1.0f,
            _ => 1f
        };
