...
using Reese.Common.GhostSpectate.TeammateOverlay;
using Reese.Common.GhostSpectate.UI.Tabs;
using Reese.Common.GhostSpectate.UI.Tabs.NPCs;
...
internal sealed class SpectatorInfoPanel : UIElement
{
