...
using Reese.Common.GhostSpectate.Hooks;
...
public static class EntityDrawer
{
    ...
    private static float GetPlayerScale()
    {
        ...
        {
            ClientConfig.SpectateUISize.Small => 1.0f,
            ClientConfig.SpectateUISize.Medium => 1.25f,
            ClientConfig.SpectateUISize.Big => 1.5f,
            _ => 1f
        };
    ...
    private static float GetPlayerScaleVerticalOffset()
    {
        ...
        float scale = clientConfig.spectateUISize switch
        {
            ClientConfig.SpectateUISize.Small => 5f,
            ClientConfig.SpectateUISize.Medium => 10f,
            ClientConfig.SpectateUISize.Big => 20,
            _ => 1f
        };
