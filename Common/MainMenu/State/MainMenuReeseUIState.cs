...
internal sealed class ReplaysBrowserUIState : UIState
{
    ...
    public override void OnActivate()
    {
        ...
        UIHoverImage openFolderButton = new(UICommon.ButtonOpenFolder, $"Open {folderName}")
        {
        ...
        UIHoverImage refreshButton = new(UICommon.ButtonDownloadTexture, $"Refresh {folderName}")
        {
            RemoveFloatingPointsFromDrawPosition = true,
            UseTooltipMouseText = true,
            Left = { Pixels = 36f },
